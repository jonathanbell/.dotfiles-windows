...
# OK, looks like we have the enviroment we are expecting.. Whef.
...
PACKAGES=( curl nodejs meld imagemagick xclip wget npm trimage ffmpeg apache2 mysql-server mysql-client php mysql-workbench sqlite3 sqlitebrowser libapache2-mod-php php-mcrypt php-mysql php-cli ruby rubygems )
for i in "${PACKAGES[@]}"
do
...
# Alternatively, we could syslink a .gitconfig file to a .gitconfig file in this repo (.dotfiles/git/.gitgonfig).
