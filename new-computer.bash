...
PACKAGES=( curl nodejs meld pgadmin3 youtube-dl imagemagick xclip wget npm trimage ffmpeg apache2 mysql-server mysql-client php mysql-workbench sqlite3 sqlitebrowser libapache2-mod-php php-mcrypt php-mysql php-cli ruby rubygems )
for i in "${PACKAGES[@]}"
do
